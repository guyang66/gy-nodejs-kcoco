module.exports = {
  content: [
    {
      image: '/images/product/ai/speech/apply/a1.jpg',
      alt: 'QJ语音',
      height: 728,
      imageWidth: 712,
      imageHeight: 712,
      ...
      buttonText: '联系我们',
      href: '/form?from=/product/ai/speech&action=apply',
      solutions: [
      ...
      products: [
        ...
        {
          name: 'AI识别',
          icon: '/images/product/logo/ai/shibie.svg',
          key: 'discriminate',
          alt: 'AI识别',
    ...
    {
      image: '/images/product/ai/speech/apply/a2.png',
      alt: '极速语音',
      height: 728,
      imageWidth: 712,
      imageHeight: 712,
