module.exports = {
  title: '产品优势',
  cover: '/images/product/ai/discriminate/advantage/main.jpg',
  content: [
    {
      title: '技术顶尖',
      desc: null,
      text: '假设采样频率为Fs，信号频率F，采样点数为N。那么FFT之后结果就是一个为N点的复数。每一个点就对应着一个频率点',
      icon: '/images/product/ai/discriminate/advantage/a1.svg',
      alt: '技术顶尖',
    },
    {
      title: '直流信号',
      ...
      icon: '/images/product/ai/discriminate/advantage/a2.svg',
      alt: '直流信号',
    },
    {
      title: '心跳监测',
      ...
      icon: '/images/product/ai/discriminate/advantage/a3.svg',
      alt: '心跳监测',
    },
    {
      title: '高频率分辨',
      ...
      icon: '/images/product/ai/discriminate/advantage/a4.svg',
      alt: '高频率分辨',
    },
  ],
};
