module.exports = {
  content: [
    {
      image: '/images/product/ai/discriminate/apply/a1.jpg',
      alt: '数字化改革',
      height: 728,
      imageWidth: 712,
      imageHeight: 712,
      ...
      buttonText: '联系我们',
      href: '/form?from=/product/ai/discriminate&action=apply',
      solutions: [
    ...
    {
      image: '/images/product/ai/discriminate/apply/a2.jpg',
      alt: '数字化上云',
      height: 728,
      imageWidth: 712,
      imageHeight: 712,
      ...
      products: [
        {
          name: 'titi',
          icon: '/images/product/logo/ai/titi.svg',
          key: 'titi',
          alt: 'titi',
        ...
        {
          name: '菩提',
          icon: '/images/product/logo/ai/puti.svg',
          key: 'puti',
          alt: '菩提',
