module.exports = {
  content: [
    {
      image: '/images/product/ai/algorithm/apply/a1.jpg',
      alt: '推荐系统算法',
      height: 1024,
      imageWidth: 712,
      imageHeight: 1008,
      ...
      buttonText: '联系我们',
      href: '/form?from=/product/ai/algorithm&action=apply',
      scenes: [
      ...
      products: [
        ...
        {
          name: '细雨',
          icon: '/images/product/logo/ai/xiyu.svg',
          key: 'xiyu',
          alt: '细雨',
    ...
    {
      image: '/images/product/ai/algorithm/apply/a2.jpg',
      alt: '贪心算法',
      height: 1024,
      imageWidth: 712,
      imageHeight: 1008,
    ...
    {
      image: '/images/product/ai/algorithm/apply/a3.jpg',
      alt: '模拟退火算法',
      height: 1024,
      imageWidth: 712,
      imageHeight: 1008,
      ...
      products: [
        {
          name: '企业云',
          icon: '/images/product/logo/ai/shuying.svg',
          key: 'enterprise',
          alt: '企业云',
