  ...
  content: [
    {
      ...
      icon: '/images/product/fruits/avocado/core/a1.png',
      alt: '文档可靠',
    },
    {
      title: '即开即用',
      text: '叶片长圆形，长2～2.2米，宽60～70厘米，先端钝圆，基部近圆形，两侧对称，叶面深绿色，无白粉，叶背浅绿色，被白粉',
      icon: '/images/product/fruits/avocado/core/a2.png',
      alt: '即开即用',
    },
    {
      title: '装备精良',
      text: '叶柄短粗，通常长在30厘米以下，叶翼显著，张开，边缘褐红色或鲜红色，穗状花序下垂，花序轴密被褐色绒毛，苞片外面紫红色',
      icon: '/images/product/fruits/avocado/core/a3.png',
      alt: '装备精良',
    },
    {
      title: '操作简单',
      text: '花乳白色或略带浅紫色，离生花被片近圆形，全缘，先端有锥状急尖，合生花被片的中间二侧生小裂片长，长约为中央裂片的1/2',
      icon: '/images/product/fruits/avocado/core/a4.png',
      alt: '操作简单',
    },
    {
      title: '简单灵活',
      text: '最大的果丛有果360个之多，重可达32千克，一般的果丛有果8～10段，约有果150～200个',
      icon: '/images/product/fruits/avocado/core/a5.png',
      alt: '简单灵活',
    },
    {
      title: '简单灵活',
      text: '最大的果丛有果360个之多，重可达32千克，一般的果丛有果8～10段，约有果150～200个',
      icon: '/images/product/fruits/avocado/core/a6.png',
      alt: '简单灵活',
    },
  ],
};
