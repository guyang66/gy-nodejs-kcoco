module.exports = {
  content: [
    {
      image: '/images/product/vegetables/bolt/apply/a1.jpg',
      alt: '拉倒生炒',
      height: 728,
      imageWidth: 712,
      imageHeight: 712,
      title: '拉倒生炒',
      desc: '装扮大招：将正前方最多3只僵尸吸至自己嘴边，吞下它们，或是对无法吞入的僵尸造成1000伤害，吞噬完毕后使正前方所有僵尸退至行末，并吹落该行所有铁桶僵尸的铁桶。裹在宿存花被片内。薄荷加强：咀嚼时间缩短至1.5秒，每次可额外吞噬六只僵尸。',
      buttonText: '联系我们',
      href: '/banana.html',
      solutions: [
    ...
    {
      image: '/images/product/vegetables/bolt/apply/a2.jpg',
      alt: '菜苔炒青菜',
      height: 728,
      imageWidth: 712,
      imageHeight: 712,
      title: '菜苔炒青菜',
      desc: '菜苔炒青菜而产生的对人体、建筑等的危害。雷电是一种自然放电现象。雷击是自然灾害，不仅会造成设备、房屋设施的损坏，而且可能引起火灾、爆炸，甚至还可能伤害人、畜等。避区栽种。',
      buttonText: '申请试用',
      href: '/banana.html',
      solutions: [
        '收集10个碎片兑换或宝物抽奖',
    ...
    {
      image: '/images/product/vegetables/bolt/apply/a3.png',
      alt: '红烧牛肉',
      height: 728,
      imageWidth: 712,
      imageHeight: 712,
      title: '红烧牛肉',
      desc: '由于滚筒僵尸的攻击力和防御力很高是依赖于他所推的滚筒，因此当务之急必须消灭滚筒，建议使用尖刺植物攻击种。吸引火力，一段时间后自动破裂',
      buttonText: '申请试用',
      href: '/banana.html',
      solutions: [
        '投手、穿透类植物（攻击时滚筒不会滚动）可直接攻击僵尸本体',
